...
export const unitResultsSearchReducerBuilder = (name, resultParser = parseResults) => (state = {facets:FAKE_DATA, totalCount: "6",data:{ listType: 'DonDiegoType', values : FAKE_DATA_LIST}}, action = {}) => {
