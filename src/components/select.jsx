...
class Select extends PureComponent {
    ...
    */
    render() {
        const { autoFocus, error, labelKey, multiple, name, placeholder, style, value, valueKey, disabled, onChange, size } = this.props;
        const selectProps = { autoFocus, disabled, size };
        const currentValue = find(this.allValues, (o) => o[valueKey] === value);
        const currentLabel = currentValue[labelKey];
        return (
